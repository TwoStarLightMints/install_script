...
pacman -S python-psutil qtile ly helix git alsa-utils libreoffice-still alacritty fish ttf-hack-nerd starship gimp rustup rofi code xorg virtualbox-guest-utils openssh go bash-language-server pcmanfm-gtk3 xdg-user-dirs llvm lldb clang htop --noconfirm
